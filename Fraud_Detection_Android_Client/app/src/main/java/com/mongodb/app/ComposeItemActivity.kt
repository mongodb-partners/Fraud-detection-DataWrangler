...
import com.mongodb.app.presentation.tasks.*
...
class ComposeItemActivity : ComponentActivity() {
    ...
    private val itemAddMessage: ItemAddMessageViewModel by viewModels {
        ItemAddMessageViewModel.factory(repository, this)
    }
